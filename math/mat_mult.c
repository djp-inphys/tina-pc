...
Matrix *imatrix_mult(Matrix * mat1, Matrix * mat2);
Matrix *fmatrix_mult(Matrix * mat1, Matrix * mat2);
Matrix *dmatrix_mult(Matrix * mat1, Matrix * mat2);
...
Matrix *matrix_mult(Matrix * mat1, Matrix * mat2)
{
    ...
    {
    case int_v:
	prod = imatrix_mult(m1, m2);
	break;
    case float_v:
	prod = fmatrix_mult(m1, m2);
	break;
    case double_v:
	prod = dmatrix_mult(m1, m2);
	break;
    }
...
Matrix *imatrix_mult(Matrix * mat1, Matrix * mat2)
{
    ...
    if ((n1 = mat1->n) != mat2->m)
    {
	error("imatrix_mult: sizes not matched", warning);
	return (NULL);
    }
    m = mat1->m;
    n = mat2->n;
